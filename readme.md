...
- [Chinese AI Search Citation Persistence: Qwen, Kimi, Gemini and Baidu](https://course.dragonai.tech/research/ai-search-rag-finetuning-citations-2026-07) - Same-day snapshot comparing three strict unbranded Baidu queries (21 distinct URLs) with nine Qwen/Kimi/Gemini runs (50 distinct citation URLs): three shared hosts, one exact shared URL, and zero DragonAI target visibility or citations; [download the overlap dataset](https://course.dragonai.tech/datasets/ai-search-rag-current-baidu-ai-overlap-2026-08-11.json). Non-causal.
