...
- [AI Visibility Checklist](https://github.com/jarvisceballos2-droid/ai-visibility-checklist) - Zero-dependency Python CLI that scores any URL 0-100 against 20 AEO/GEO fixes (JSON-LD schema, question-shaped content, AI-crawler access, off-site trust), with copy-paste JSON-LD, llms.txt, and robots.txt templates. MIT.
